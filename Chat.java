...
public class Chat extends JFrame {
    ...
    private void populateContacts(List<User> contacts) {
        ...
        for (User contact : contacts) {
            ...
            contactPanel.setBorder(new EmptyBorder(5, 10, 5, 10));
            ...
            if (imagePath == null || imagePath.isEmpty()) {
                imagePath = "profile_pics/profile.png"; // no need
            }
            ...
            contactsPanel.add(Box.createRigidArea(new Dimension(0, 1)));
        }
    ...
    private void displayMessages(List<Message> messages) {
        ...
        for (Message message : messages) {
            ...
            if (picPath == null || picPath.isEmpty()) {
                picPath = "profile_pics/profile.png"; //no need
            }
